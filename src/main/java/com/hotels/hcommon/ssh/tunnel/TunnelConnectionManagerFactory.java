...
public interface TunnelConnectionManagerFactory {
  ...
  TunnelConnectionManager create(String remoteHost, int remotePort);

  TunnelConnectionManager create(String localHost, int localPort, String remoteHost, int remotePort);
