 ...
 */
package com.hotels.hcommon.ssh.validation.validator;
...
/**
 * Inspired by Hibernate's
 * {@link org.hibernate.validator.internal.constraintvalidators.hv.EmailValidatorEmailValidator}, this class checks that
 * a given character sequence (e.g. {@link String}) is a well-formed list of hostnames, optionally preceded by a
 * username, separated by "->", e.g. "user1@host1 -> host2".
 * <p>
